extension MapExtension<T> on Map<T, T> {
  ...
  /// Example:
  /// ```dart
  /// Map<String, dynamic> map = {"id": ", "name": "John", "age": 30};
  /// var newMap = map.retainKeys(["id", "name"]);
  /// print(newMap); // {"id": ", "name": "John"}
  /// ```
  ...
  ///Example:
  ///```dart
  /// Map<String, dynamic> map = {'id': '11, 'name': 'Desk'};
  /// int id = map.getId;
  /// print(id); // Output: '11
  ///
  ...
  /// print(map.getBool('isActive'));  // Output: true
  ...
  /// Example:
  ///```dart
  /// Map<String, dynamic> map = {'id': '1, 'name': 'John Doe', 'age': 30};
  /// print(map.getInt('id')); // '1
  ...
  /// Example:
  /// ```dart
  /// Map<String, dynamic> map = {'items': [', 2, 3, 4], 'prices': [20.0, 30.0, 40.0]};
  ///
  /// map.getList<int>('items') // returns [', 2, 3, 4]
